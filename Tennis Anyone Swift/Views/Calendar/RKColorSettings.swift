...
class RKColorSettings : ObservableObject {
    ...
    @Published var selectedBackColor: Color = Color(Constants.redBackgroundColor)
    @Published var disabledBackColor: Color = Color.clear
    @Published var betweenStartAndEndBackColor: Color = Color(Constants.blueBackgroundColor)
